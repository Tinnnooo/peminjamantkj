<section class="list_barang_section" style='margin-top: 5rem;'>
    ...
    <div class="row justify-content-between">
        <div class="col-md-auto">
            <form class="form-inline" method="GET" action="{{ route('ambilBahan') }}">
    ...
    <table class="table">
        ...
        <tbody class="tbody-barang">
            ...
            <tr>
                <th scope="row">{{ $no++ }}</th>
                <td class="col-md-2">{{ $bahan->user->nama_lengkap }}</td>
                <td style="width: 15%;">{{ $bahan->bahan->nama_bahan }}</td>
                <td style="width: 10%;">{{ $bahan->tgl_ambil }}</td>
                <td style="width: 10%;">{{ $bahan->wkt_ambil }}</td>
                <td style="width: 12%;">{{ $bahan->qty }}</td>
                <td class="col-md-2">{{ $bahan->deskripsi }}</td>
                <td class="col-md-1">{{ $bahan->status }}</td>
                <td class="col-md-3">
