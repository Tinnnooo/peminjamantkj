<section class="section_input" style="margin-top: 5rem;">
    <div class="section_input_header d-flex">
        <div class="header_left">
            <div class="header_icon">
                <button type="button" class="btn btn-danger btn-sm" onclick="window.location.href='{{ route('pinjamBarang') }}'">
    ...
    <form action="{{ route('kirimPinjaman') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="container section_input_main1 shadow-lg bg-white rounded">
            ...
            <div class="input_main mt-4">
                <div class="form-group datalist_barang">
                    ...
                    <input for="nama_barang" class="form-control mt-2" id="inputNama_barang" placeholder="-- Pilih Barang --" name="nama_barang" autocomplete="off" />
                    <datalist id="optionNama_barang">
        ...
        <div class="container section_input_main2 shadow-lg bg-white rounded">
            ...
            <div class="input_main mt-4">
                ...
                <div class="submit_button">
                    ...
                    <button type="button" class="btn btn-danger" onclick="window.location.href='{{ route('pinjamBarang') }}'">
